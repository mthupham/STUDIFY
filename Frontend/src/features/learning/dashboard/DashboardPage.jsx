...
export default function Dashboard() {
  ...
  // Mock data cho danh sách nhiệm vụ học tập hôm nay
  const [tasks, setTasks] = useState([
    {
      id: 1,
      title: "Listening: Market Trends",
      type: "Recommended",
      duration: "15 mins",
      isOptional: false,
      icon: (
  ...
  return (
    ...
    <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-8 px-4 py-6 pb-16 font-['Inter',_sans-serif] sm:px-6 sm:py-8 lg:px-8">
      ...
      <div className="relative flex w-full flex-col items-start justify-start overflow-hidden rounded-2xl bg-gradient-to-r from-sky-700 to-blue-600 p-6 shadow-lg sm:p-8">
        ...
        <div className="absolute right-4 top-2 pointer-events-none opacity-25">
          <svg
            ...
            width="180"
            height="180"
            viewBox="0 0 300 300" /* Mở rộng khung nhìn để bao quát toàn bộ tọa độ vẽ */
            fill="none"
          >
            <path
      ...
      {/* BENTO GRID LAYOUT: Bố cục chia hai cột chính (Trái: Tiến độ & Kế hoạch, Phải: Sidebar widget) */}
      <div className="grid w-full grid-cols-1 gap-6 items-start lg:grid-cols-12">
        ...
        <div className="flex flex-col gap-6 lg:col-span-8">
          ...
          <div className="flex flex-col gap-8 rounded-2xl border border-slate-300 bg-slate-50 p-6 shadow-sm sm:p-8">
            ...
            {/* Vùng thông tin chi tiết (Bài học, Chuỗi ngày học & Biểu đồ phần trăm) */}
            <div className="flex flex-col gap-6 md:flex-row items-center justify-between">
              {/* List chứa các block thông tin nhỏ bên trái */}
              <div className="flex w-full flex-col gap-4 md:w-2/3">
                {/* Block: Bài học hiện tại */}
              ...
              {/* Sử dụng Component ProgressBar truyền giá trị progress động */}
              <div className="relative flex h-36 w-36 items-center justify-center">
                {/* SVG Hình tròn tiến độ */}
                <svg className="h-full w-full -rotate-90" viewBox="0 0 36 36">
                  ...
                  <circle
                    ...
                    strokeWidth="3"
                  />
                  {/* Vòng tròn tiến độ chạy động (Màu xanh chủ đạo) */}
                  <circle
                    cx="18"
                    cy="18"
                    r="16"
                    ...
                    strokeLinecap="round"
                    /* Công thức tính toán: 
                    - Tổng chu vi vòng tròn (100%) = 2 * pi * r = 2 * 3.1416 * 16 ≈ 100.5
                    - strokeDasharray: "Chu_vi_tiến_độ Chu_vi_tổng"
                    - Với 65%: 65 * 100.5 / 100 = 65.32
                    */
                    strokeDasharray="65.32 100.5"
                  />
                </svg>

                {/* Chữ hiển thị chính giữa hình tròn */}
          ...
          <div className="flex flex-col gap-6 rounded-2xl border border-slate-300 bg-slate-50 p-8 shadow-sm">
            ...
            {/* Danh sách nhiệm vụ lặp qua mảng state tasks */}
              ...
              {tasks.map((task) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    {/* Vòng tròn chứa Icon - Sử dụng màu nền động và hiển thị trực tiếp component SVG */}
                    <div
                      className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full ${task.bgColor}`}
                    >
                      {task.icon}
                    </div>

                    {/* Phần text thông tin Task */}
                    <div>
                  ...
                  {/* Nút thao tác (Action Button) bên phải */}
                  <button className="rounded-full p-2 text-gray-400 hover:bg-slate-100 hover:text-gray-600 transition">
                    {/* Mẹo: Thay thế div bằng một icon cụ thể như mũi tên hoặc dấu tích (Dưới đây là icon mũi tên Chevron Right làm ví dụ) */}
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
        ...
        <div className="flex flex-col gap-6 lg:col-span-4">
          ...
          <div className="relative flex flex-col gap-4 overflow-hidden rounded-2xl border border-slate-300 bg-slate-50 p-5 shadow-sm sm:p-6">
            ...
            {/* Khung hiển thị thông tin buổi Review khẩn cấp */}
            <div className="flex flex-col gap-2 rounded-xl border border-emerald-800/10 bg-emerald-300/20 p-4">
              ...
              {/* Footer của thông báo: Thời gian và tag Urgent */}
          ...
          {/* MOTIVATION CARD: Thẻ tạo động lực rỗng */}
