    ...
    try {
      ...
      setMessage(
        response.data?.message ||
          `Group "${createdGroup?.name || groupName}" created successfully!`
      );
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600 text-base">
            Build a community to practice English with peers and share resources.
          </p>
        </div>
          ...
          <div className="space-y-6">
            <div className="bg-indigo-50/50 border border-slate-200 rounded-2xl p-6 sm:p-8 flex flex-col items-center text-center space-y-6">
              ...
              <p className="text-xs text-gray-500 font-medium leading-relaxed">
                Click the pencil icon above to search and customize your group icon.
              </p>
            </div>
            ...
            <div className="bg-amber-50/80 border border-amber-200/80 rounded-2xl p-6 flex gap-3.5 items-start text-amber-900">
              ...
              <div className="space-y-1 text-xs">
                ...
                <p className="leading-relaxed text-amber-900/90">
                  &quot;Successful study groups usually focus on a specific skill
                  level or goal. Keep your group name descriptive to help relevant
                  learners find you easily!&quot;
                </p>
              </div>
            </div>
          </div>
