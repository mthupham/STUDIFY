...
import NotificationDropdown from "../features/notification/notification_dropdown";
...
export default function MainLayout({ children }: MainLayoutProps) {
  const [isHovered] = React.useState<boolean>(false);
  const [showSignOutModal, setShowSignOutModal] = React.useState<boolean>(false);

  const navigate = useNavigate();
  const user = useAuthStore((state: UserState) => state.user);
  ...
  return (
    <div style={styles.shell}>
      <aside style={styles.sidebar}>
        ...
        <button
          ...
          style={{
            ...
            background: isHovered ? "#00479A" : "#0058BE",
          }}
          onMouseEnter={(e: React.MouseEvent<HTMLButtonElement>) => {
            e.currentTarget.style.background = "#00479A";
          }}
      ...
      {showSignOutModal && (
        <div style={styles.modalOverlay} onClick={() => setShowSignOutModal(false)}>
          <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
            <h3 style={styles.modalTitle}>Do you want to sign out?</h3>
