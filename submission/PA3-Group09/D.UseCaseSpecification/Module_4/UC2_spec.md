...
6. The User types or fills in the **Explanation** field for the flashcard (refer to UC8 – Write Explanation).

7. Optionally, the User adds one or more tags to the flashcard (refer to UC3 – Add Tags).
...
This use case extends to UC3 (Add Tags) when, at Step 7 of the Basic Flow, the User chooses to assign one or more tags to the flashcard being created from the highlighted text.

### 6.2 Write Explanation

This use case includes UC8 (Write Explanation) as the User must provide an explanation (back side of the card) after the Term is auto-populated from the highlighted text (Step 6 of the Basic Flow).
