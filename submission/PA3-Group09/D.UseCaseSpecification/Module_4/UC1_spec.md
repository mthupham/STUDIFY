...
4. Optionally, the User adds one or more tags to the flashcard by interacting with the tag input component (refer to UC3 – Add Tags).
...
This use case extends to UC3 (Add Tags) when, at Step 4 of the Basic Flow, the User chooses to assign one or more tags to the flashcard being created.

### 6.2 Write Explanation

This use case includes UC8 (Write Explanation) as the User must provide an explanation for the flashcard term during the manual entry process (Step 3 of the Basic Flow).
