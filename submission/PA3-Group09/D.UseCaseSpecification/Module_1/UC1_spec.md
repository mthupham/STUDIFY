...
- [Studify](#studify)
  - [Use-Case Specification: Register New Account](#use-case-specification-register-new-account)
  ...
  - [3. Special Requirements](#3-special-requirements)
    ...
    - [3.2 Response Time](#32-response-time)
    - [3.3 Email Uniqueness](#33-email-uniqueness)
  - [4. Preconditions](#4-preconditions)
    - [4.1 No Existing Account](#41-no-existing-account)
    - [4.2 Network Connectivity](#42-network-connectivity)
  - [5. Postconditions](#5-postconditions)
    - [5.1 Account Created](#51-account-created)
    - [5.2 User Authenticated](#52-user-authenticated)
    - [5.3 Onboarding Initiated](#53-onboarding-initiated)
  - [6. Extension Points](#6-extension-points)
    - [6.1 Onboarding Survey Trigger](#61-onboarding-survey-trigger)
