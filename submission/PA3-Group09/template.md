...
> **Note:** The following template is provided for use with the Rational Unified Process. Text enclosed in square brackets and displayed in blue italics is included to provide guidance to the author and should be deleted before publishing the document.
  ...
  - [2. Flow of Events](#2-flow-of-events)
    ...
    - [2.2 Alternative Flows](#22-alternative-flows)
      - [2.2.1 \< First Alternative Flow \>](#221--first-alternative-flow-)
        - [\< An Alternative Subflow \>](#-an-alternative-subflow-)
